  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => Promise.resolve().then(() => require("./FloatingTanStackRouterDevtools-CFeBvnJm.cjs")));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => Promise.resolve().then(() => require("./BaseTanStackRouterDevtoolsPanel-CBZmDPAq.cjs")).then((n) => n.BaseTanStackRouterDevtoolsPanel$1));
...
//# sourceMappingURL=index-DI9oTGDd.cjs.map
